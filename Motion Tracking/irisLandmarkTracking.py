...
if face_landmarks:
    ...
    print(f"xscale_factor: {xscale_factor}, yscale_factor: {yscale_factor}, screen width: {screen_w}, eye width: {eye_width}")
...
try:
    while True:
        ...
        if face_landmarks:
            ...
            pg.moveTo(current_cursor_pos.x + (cur_x - prev_x) * xscale_factor, current_cursor_pos.y + (cur_y - prev_y) * yscale_factor, duration=0.3)
